export default function Menu({ onGoInventory, onGoCash, onGoContabilidad, onLogout }) {
  return (
    <div className="min-h-screen p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
        ...
        <button onClick={onGoContabilidad} className="aspect-[4/2] rounded-xl border border-white/10 bg-white/10 hover:bg-white/15 transition text-left p-6">
          <div className="text-2xl font-semibold">Contabilidad</div>
          <div className="text-sm text-gray-300">Realiza ventas, factura prendas y elige método de pago.</div>
        </button>
      </div>
    </div>
